...
- 連合とは、当サービス以外の関連する連合型ソーシャル・ネットワーキング・サービス(例: MastodonやPleromaといったシステムベースのSNS)の総称を指します。
...
当サービスは原則として、サーバーの停止・再起動を行う際は公告アカウントでその旨を通知するよう務めるものとします。
...
連合のアカウントであっても当サービスで受信した場合、当サービスの禁止事項が適用されるものとします。
  ...
  13. 企業・法人等が商用目的でアカウントを開設し、その企業・法人等に利益が生じる宣伝、広告、勧誘、営業行為（ただし、当サービスが承認した場合は除きます）
...
文字数の多い投稿になる場合、罰則規定はありませんが、できる限りCWを設定してコンパクトに表示するようにお願いいたします。

画像に不適切な内容が含まれる可能性がある場合、該当する画像はNSFWをつけることを義務付けています。

当サービスが不適切であると判断した場合、該当の画像にNSFWフラグを強制的に付与、削除や該当の画像を投稿した利用者の隔離・凍結を行うことができるものとします。
...
また、アップロードしたデータは連合に公開されることがあるものとします。
...
当サービスは個人運用であるため、不具合等によりデータの損失があっても、当サービスは一切の責任を追わないものとします。ですので、重要なデータを保管するのは控えてください。
...
**※現在ベースシステムの関係上、アカウントの削除が行なえません。申し訳ありませんがベースシステムの開発者の対応があるまでしばらくお待ち下さい。どうしてもアカウントの削除を行いたい場合は、お手数ですが管理者([@YuzuRyo61@yuzulia.xyz](https://yuzulia.xyz/@YuzuRyo61))へダイレクトメッセージもしくはチャットにてご連絡ください。**
